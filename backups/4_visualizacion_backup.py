"""
NPS/CSAT Table Visualization Tool

Este script genera una tabla HTML detallada de las métricas NPS y CSAT
desde la base de datos PostgreSQL. Muestra datos mes por mes más un
consolidado total.

Características:
- Tabla HTML detallada y legible
- Fila de totales consolidados
- Exportable y fácil de compartir
- Filtro por mes opcional

Uso:
    python visualize_nps.py                    # Tabla completa
    python visualize_nps.py --month 2025-08    # Filtrar por mes específico
"""
