...
CATEGORIAS_YAML = "categorias.yml"
...
def analyze_rejected_texts(engine, limit: int = 10000) -> pd.DataFrame:
    ...
    # Importar TextCleaner del script 05_categorizar_motivos.py
    # Nota: Esta línea puede necesitar ajuste dependiendo de la estructura del proyecto
    # exec(open('../05_categorizar_motivos.py', encoding='utf-8').read(), globals())
    cleaner = TextCleaner()
